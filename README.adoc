...
** If they were started as a Docker container, make sure you are in `spring-cloud-stream-kafka-elasticsearch` root folder and run the script below
+
[source]
----
./stop-apps.sh
...
* To remove the Docker images created by this project, make sure you are in `spring-cloud-stream-kafka-elasticsearch` root folder and run
+
[source]
----
