...
In a terminal and inside `spring-cloud-stream-elasticsearch` root folder run
...
In a terminal and inside `spring-cloud-stream-elasticsearch` root folder, in order to build the applications docker images, you can just run the following script
...
In a terminal and inside `spring-cloud-stream-elasticsearch` root folder, run following script
