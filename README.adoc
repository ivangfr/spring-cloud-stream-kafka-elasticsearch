...
The video bellow shows the websocket operation. An new is created in `producer-api` and, immediately, it is shown in
`news-client`

video::images/websocket-operation.mp4[options=autoplay,loop]
