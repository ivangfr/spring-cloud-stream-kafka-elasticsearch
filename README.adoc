...
+
image::documentation/eureka-with-apps.png[]
...
+
image::documentation/zipkin-sample.png[]
...
+
image::documentation/kafka-manager-consumers.png[]
+
_Configuration_
+
...
+
image::documentation/schema-registry.png[]
